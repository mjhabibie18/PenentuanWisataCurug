...
$(document).ready(function() {
    ...
    document.getElementById("avgNciku2").style.display = "none";
    var offset = 0;
    getHum();
    function getHum()
    {
      var xNo = new Array();
      var yHum = new Array();
      var url = "http://localhost/rekomendasiwisata/Raspi04/api/apiGetDataJson_humciku.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
  ...
  function predictHum(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart-ciku3"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart-ciku4"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgDataciku3').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgDataciku4').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgNciku2').innerHTML = yPred;
  }  
});