...
$(document).ready(function() {
    ...
    document.getElementById("avgNseri2").style.display = "none";
    var offset = 0;
    getHum();
    function getHum()
    {
      var xNo = new Array();
      var yHum = new Array();
      var url = "http://localhost/rekomendasiwisata/Raspi04/api/apiGetDataJson_humseri.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
  ...
  function predictHum(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart-seri3"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart-seri4"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgDataseri3').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgDataseri4').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgNseri2').innerHTML = yPred;
  }  
});