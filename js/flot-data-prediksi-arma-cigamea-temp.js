...
$(document).ready(function() {
    ...
    document.getElementById("avgNciga1").style.display = "none";
    var offset = 0;
    getTemp();
    function getTemp()
    {
      var xNo = new Array();
      var yTemp = new Array();
      var url = "http://localhost/rekomendasiwisata/Raspi04/api/apiGetDataJson_tempciga.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
  ...
  function predictTemp(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart-ciga1"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart-ciga2"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgDataciga1').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgDataciga2').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgNciga1').innerHTML = yPred;
  }  
});