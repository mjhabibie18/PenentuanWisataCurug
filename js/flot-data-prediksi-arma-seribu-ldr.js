...
$(document).ready(function() {
    ...
    document.getElementById("avgNseri3").style.display = "none";
    var offset = 0;
    getLdr();
    function getLdr()
    {
      var xNo = new Array();
      var yLdr = new Array();
      var url = "http://localhost/rekomendasiwisata/Raspi04/api/apiGetDataJson_ldrseri.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
        ...
        success: function(response){           
          for(i=0;i<response.records.length;i++){
            ...
            yLdr[i] = parseInt(response.records[i].ldr);
            console.log(yLdr[i]);                  
          }
          predictLdr(xNo, yLdr);
        }            
  ...
  function predictLdr(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart-seri5"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart-seri6"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgDataseri5').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgDataseri6').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgNseri3').innerHTML = yPred;
  }  
});