...
$(document).ready(function() {
    ...
    document.getElementById("avgNciga3").style.display = "none";
    var offset = 0;
    getLdr();
    function getLdr()
    {
      var xNo = new Array();
      var yLdr = new Array();
      var url = "http://localhost/rekomendasiwisata/Raspi04/api/apiGetDataJson_ldrciga.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
  ...
  function predictLdr(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart-ciga5"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart-ciga6"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgDataciga5').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgDataciga6').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgNciga3').innerHTML = yPred;
  }  
});