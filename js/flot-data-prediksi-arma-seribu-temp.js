...
$(document).ready(function() {
    ...
    document.getElementById("avgNseri1").style.display = "none";
    var offset = 0;
    getTemp();
    function getTemp()
    {
      var xNo = new Array();
      var yTemp = new Array();
      var url = "http://localhost/rekomendasiwisata/Raspi04/api/apiGetDataJson_tempseri.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
  ...
  function predictTemp(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart-seribu1"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart-seribu2"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgDataseri1').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgDataseri2').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgNseri1').innerHTML = yPred;
  }  
});